...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      {/* NAV */}
      <nav className="sticky top-0 z-50 bg-white/90 dark:bg-gray-950/90 backdrop-blur border-b border-green-50 dark:border-gray-800 px-6 md:px-12 h-16 flex items-center justify-between">
        <span className="text-xl font-bold text-green-900 dark:text-green-400 tracking-tight">theKabari</span>
        ...
        <div className="flex items-center gap-3">
          <ThemeToggle />
          <Link href="/auth" className="px-4 py-2 rounded-full border border-gray-200 dark:border-gray-700 text-sm font-semibold hover:border-green-400 hover:text-green-600 dark:text-gray-300 dark:hover:text-green-400 transition-all">
            Login
          </Link>
          <Link href="/auth?tab=signup" className="px-4 py-2 rounded-full bg-green-400 text-white text-sm font-semibold hover:bg-green-900 transition-colors">
            Shuru Karo ↗
          </Link>
        </div>
      </nav>
      ...
      {/* HERO */}
      <section className="max-w-6xl mx-auto px-6 md:px-12 py-20 md:py-28 grid md:grid-cols-2 gap-16 items-center">
        <div>
          <div className="inline-flex items-center gap-2 bg-green-50 dark:bg-green-950 border border-green-100 dark:border-green-900 rounded-full px-4 py-1.5 text-sm font-semibold text-green-600 dark:text-green-400 mb-6">
            <span className="w-2 h-2 bg-green-400 rounded-full animate-pulse" />
            Pakistan ka #1 gamified scrap pickup
          </div>
          <h1 className="text-5xl md:text-7xl font-black leading-[0.95] tracking-tighter mb-6 text-gray-900 dark:text-white">
          ...
          <p className="text-lg text-gray-500 dark:text-gray-400 leading-relaxed max-w-md mb-8">
            Free doorstep pickup. Instant Easypaisa payment. Real XP aur badges earn karo. Ek kg at a time Pakistan saaf karo.
          </p>
          <div className="flex gap-3 flex-wrap mb-10">
            <Link href="/auth?tab=signup" className="px-8 py-4 rounded-full bg-green-400 text-white font-bold text-base hover:bg-green-900 transition-colors">
              Pehla quest shuru karo ↗
            </Link>
            <a href="#how" className="px-8 py-4 rounded-full border-2 border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-bold text-base hover:border-green-400 hover:text-green-600 dark:hover:text-green-400 transition-all">
          ...
          <div className="flex gap-8 pt-6 border-t border-gray-100 dark:border-gray-800">
            {[["8k+", "active players"], ["50k+", "kg recycled"], ["10+", "cities"]].map(([n, l]) => (
              <div key={l}>
                <div className="text-3xl font-black tracking-tight text-gray-900 dark:text-white">{n}</div>
                <div className="text-sm text-gray-400 dark:text-gray-500 mt-0.5">{l}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="bg-green-50 dark:bg-green-950/40 rounded-[2.5rem] p-8 relative">
            <div className="bg-gray-900 rounded-[1.8rem] w-52 p-4 shadow-2xl mx-auto">
              ...
              <div className="bg-[#111e14] rounded-2xl p-4 min-h-72">
                ...
                {[["📄","Paper","+4 XP/kg","#4CAF50"],["🧴","Plastic","+5 XP/kg","#2196F3"],["🔩","Metal","+8 XP/kg","#FF9800"]].map(([e,n,x]) => (
            ...
            <div className="absolute top-6 -right-4 bg-white dark:bg-gray-800 rounded-2xl shadow-lg px-3 py-2 flex items-center gap-2 text-sm font-semibold dark:text-white">
      ...
      {/* SCRAP TYPES */}
      <div className="bg-white dark:bg-gray-950 border-y border-gray-100 dark:border-gray-800 py-4 px-6 md:px-12">
        <div className="max-w-6xl mx-auto flex items-center gap-4 flex-wrap">
          <span className="text-sm text-gray-400 dark:text-gray-500 font-medium whitespace-nowrap">Hum collect karte hain</span>
          <div className="w-px h-5 bg-gray-200 dark:bg-gray-700" />
          <div className="flex gap-2 flex-wrap">
            {["Paper","Metal","Plastic","Electronics","Glass","Cardboard","Appliances"].map(s => (
              <span key={s} className="bg-green-50 dark:bg-green-950 border border-green-100 dark:border-green-900 rounded-full px-3 py-1 text-sm font-semibold text-green-600 dark:text-green-400">{s}</span>
            ))}
          </div>
        </div>
      </div>
      ...
      {/* HOW IT WORKS */}
      <section id="how" className="py-20 px-6 md:px-12 bg-white dark:bg-gray-950">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-4xl md:text-5xl font-black tracking-tighter mb-4 text-gray-900 dark:text-white">Kaam kaise hota hai?</h2>
          <p className="text-gray-500 dark:text-gray-400 text-base max-w-md mb-12 leading-relaxed">Char simple steps mein XP earn karo, paise lo, aur Pakistan ko saaf karo.</p>
          <div className="grid md:grid-cols-4 gap-5">
            {[
              ...
              <div key={s.n} className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-6 border border-transparent hover:border-green-100 dark:hover:border-green-900 hover:-translate-y-1 transition-all relative overflow-hidden group">
                <div className="absolute bottom-[-1rem] right-[-0.5rem] text-[6rem] font-black text-green-400/5 leading-none pointer-events-none">{s.n}</div>
                ...
                <div className="text-sm font-bold text-gray-300 dark:text-gray-600 mb-3 tracking-widest">Step {s.n}</div>
      ...
      <section id="services" className="py-20 px-6 md:px-12 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-4xl md:text-5xl font-black tracking-tighter mb-4 text-gray-900 dark:text-white">Hamare services</h2>
          <p className="text-gray-500 dark:text-gray-400 text-base max-w-md mb-12 leading-relaxed">Level up karo — jitna zyada recycle karo, utni zyada services unlock hoti hain.</p>
      ...
      {/* CTA */}
      <section className="py-20 px-6 md:px-12 dark:bg-gray-950">
        <div className="max-w-6xl mx-auto">
          <div className="bg-green-900 rounded-3xl p-12 md:p-16 text-center relative overflow-hidden">
            ...
            <h2 className="relative text-3xl md:text-5xl font-black text-white tracking-tighter mb-4">Tayaar ho Pakistan<br/>saaf karne ke liye?</h2>
            <p className="relative text-white/50 text-base mb-8 max-w-md mx-auto">Hazaron log pehle se XP earn kar rahe hain. Aaj hi shuru karo — free hai, fast hai, fun hai.</p>
      ...
      {/* FOOTER */}
      <footer className="bg-gray-900 dark:bg-gray-950 dark:border-t dark:border-gray-800 px-6 md:px-12 pt-14 pb-8">
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-10 mb-10">
          ...
          {[
            ...
            <div key={col.h}>
              ...
              {col.links.map(l => <a key={l} href="#" className="block text-sm text-white/40 hover:text-white/80 mb-2 transition-colors">{l}</a>)}
            </div>
          ))}
        </div>
        <div className="border-t border-white/5 pt-6 flex justify-between items-center flex-wrap gap-3">
